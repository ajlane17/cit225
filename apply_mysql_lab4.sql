...
\. /home/student/Data/cit225/mysql/lab2/seed_mysql_store_ri.sql
...
SELECT 'INSERT INTO system_user_lab' AS "Statement";
INSERT
...
, last_update_date)
VALUES
('REACHERJ', 1002, 1010,'REACHER','JACK', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
('OWENS', 1002, 1010,'OWENS','RAY', 1, UTC_DATE(), 1, UTC_DATE());

-- Echo to screen statement message.
SELECT 'INSERT INTO common_lookup_lab' AS "Statement";
INSERT 
INTO common_lookup_lab
...
, last_update_date)
VALUES
(1018,'MEMBER_LAB','AMERICAN_EXPRESS_CARD','American Express Card', 1, UTC_DATE(), 1, UTC_DATE());
...
, last_update_date)
VALUES
(1019,'MEMBER_LAB','DINERS_CLUB_CARD','Diners Club Card', 1, UTC_DATE(), 1, UTC_DATE());

-- Echo to screen statement message.
SELECT 'INSERT INTO member_lab' AS "Statement";
...
SET @lv_member_lab_id := last_insert_id();
...
-- Echo to screen statement message.
SELECT 'INSERT INTO contact_lab' AS "Statement";
...
SET @lv_contact_lab_id := last_insert_id();

-- Echo to screen statement message.
SELECT 'INSERT INTO address_lab' AS "Statement";
INSERT INTO address
( contact_id
, address_type
, city
